export const issues = [
  ...
  { vol: 'Vol. 05', date: 'March 2026', accent: 'var(--gc-navy)', title: 'On doing less, better', excerpt: 'A short note from BG on discernment, saying no, and why we protect the quiet.' },
