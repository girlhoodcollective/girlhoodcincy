        ...
        <div style={{ maxWidth: 560, margin: '0 auto' }}>
          {submitted ? (
            <div style={{ textAlign: 'center', background: 'var(--gc-sage-light)', border: '1px solid #dde6e2', borderRadius: 6, padding: '40px 28px' }}>
              <div style={{ fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontSize: 35, color: 'var(--gc-slate)', marginBottom: 8 }}>Thank you!</div>
              <p style={{ fontSize: 17.5, fontWeight: 300, color: 'var(--gc-ink-muted)', lineHeight: 1.7 }}>
            ...
            <div>
              ...
              <button
                ...
                disabled={sending}
                style={{ width: '100%', cursor: sending ? 'default' : 'pointer', opacity: sending ? 0.7 : 1, border: 'none', background: 'var(--gc-emerald)', color: '#fff', font: '600 14px var(--font-sans)', letterSpacing: '.18em', textTransform: 'uppercase', padding: 15, borderRadius: 3, marginBottom: 20 }}
              >
