  ...
  return (
    <div className="page-shell">
      ...
      <div style={{ background: 'var(--gc-cream)', padding: '60px 44px 52px', textAlign: 'center' }}>
        <div style={{ font: '600 16px var(--font-sans)', letterSpacing: '.24em', textTransform: 'uppercase', color: 'var(--gc-emerald)', marginBottom: 16 }}>Contact</div>
        ...
        <p style={{ fontSize: 16, fontWeight: 300, color: 'var(--gc-ink-muted)', lineHeight: 1.85, maxWidth: 480, margin: '18px auto 0' }}>
          ...
          {submitted ? (
            ...
            <div>
              ...
              <button
                ...
                disabled={sending}
                style={{ width: '100%', cursor: sending ? 'default' : 'pointer', opacity: sending ? 0.7 : 1, border: 'none', background: 'var(--gc-emerald)', color: '#fff', font: '600 16px var(--font-sans)', letterSpacing: '.18em', textTransform: 'uppercase', padding: 15, borderRadius: 3, marginBottom: 20 }}
              >
                {sending ? 'Sending…' : 'Send'}
              </button>
              <p style={{ fontSize: 16, fontWeight: 300, color: 'var(--gc-ink-muted)', textAlign: 'center' }}>
      ...
      <div style={{ background: 'var(--gc-section)', padding: '52px 44px' }}>
        <div style={{ maxWidth: 560, margin: '0 auto' }}>
          <div style={{ font: '700 16px var(--font-sans)', letterSpacing: '.2em', textTransform: 'uppercase', color: 'var(--gc-emerald)', marginBottom: 16, textAlign: 'center' }}>Quick questions</div>
