  ...
  return (
    <div className="page-shell">
      ...
      <div style={{ background: 'var(--gc-cream)', padding: '56px 44px 52px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 16, fontWeight: 300, color: 'var(--gc-ink-muted)', lineHeight: 1.8, maxWidth: 560, margin: '18px auto 0' }}>
      ...
      <div style={{ background: 'var(--gc-section)', padding: '56px 44px' }}>
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 16, fontWeight: 300, color: 'var(--gc-ink)', lineHeight: 1.85, marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 16, fontWeight: 300, color: 'var(--gc-ink)', lineHeight: 1.85, marginBottom: 20 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 8 }}>
            {APPROACH.map((a) => (
              <div key={a} style={{ background: '#fff', border: '1px solid var(--gc-border)', borderLeft: '3px solid var(--gc-emerald)', borderRadius: '0 6px 6px 0', padding: '16px 20px', fontSize: 16, color: 'var(--gc-ink)', lineHeight: 1.65 }}>
                {a}
              </div>
            ))}
          </div>
        ...
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
              ...
              <p style={{ fontSize: 16, color: 'var(--gc-ink)', lineHeight: 1.7 }}>
      ...
      <div style={{ background: 'var(--gc-slate)', padding: '56px 44px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 16, fontWeight: 300, color: 'rgba(255,255,255,.72)', lineHeight: 1.75, maxWidth: 520, margin: '0 auto 24px' }}>
