      ...
      {phase === 'results' && (() => {
        ...
        return (
          <div style={{ maxWidth: 680, margin: '0 auto', padding: '28px 24px 70px' }}>
            ...
            <h3 style={{ font: '700 16px var(--font-sans)', letterSpacing: '.24em', textTransform: 'uppercase', color: 'var(--gc-emerald)', margin: '32px 0 14px' }}>
            ...
            <h3 style={{ font: '700 16px var(--font-sans)', letterSpacing: '.24em', textTransform: 'uppercase', color: 'var(--gc-emerald)', margin: '30px 0 14px' }}>
