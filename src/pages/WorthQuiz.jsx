...
const QUESTIONS = [
  ...
  { type: 'multi', maxSelect: 3, text: 'Which Cincinnati industries feel like the right world for you?', context: 'Select up to 3. Where you can see yourself thriving and earning.', options: [{ text: "Healthcare — Cincinnati Children's, UC Health, TriHealth, Christ Hospital, Mercy Health, mental health", skills: ['people', 'coaching'] }, { text: "Consumer brands & CPG — P&G, Kroger's 84.51° data team, brand-adjacent roles", skills: ['marketing', 'storytelling'] }, { text: "Finance & banking — Fifth Third's fintech & cybersecurity push, Western & Southern", skills: ['analysis', 'operations'] }, { text: 'Nonprofits, education & social impact', skills: ['advocacy', 'teaching'] }, { text: 'Tech, startups & innovation — the Cintrifuse ecosystem, remote-first', skills: ['tech', 'systems'] }, { text: 'Creative industries — arts, media, events, hospitality, OTR', skills: ['visual', 'storytelling'] }, { text: 'Manufacturing, aerospace & skilled trades — GE Aerospace, advanced manufacturing, logistics', skills: ['systems', 'operations'] }] },
        ...
        <div style={{ background: 'var(--gc-cream)', padding: '64px 32px 72px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'relative', zIndex: 2, maxWidth: 640, margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: 10, flexWrap: 'wrap', marginBottom: 32 }}>
              <span style={{ background: '#fff', border: '1px solid var(--gc-border)', borderRadius: 100, padding: '7px 16px', fontSize: 15, color: 'var(--gc-ink-muted)' }}>
          ...
          <div style={{ maxWidth: 680, margin: '0 auto', padding: '28px 24px 70px' }}>
            <div style={{ padding: '20px 0 14px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                <span style={{ font: '600 12.5px var(--font-sans)', letterSpacing: '.18em', textTransform: 'uppercase', color: 'var(--gc-ink-muted)' }}>Progress</span>
                <span style={{ fontFamily: 'var(--font-serif)', fontSize: 22.5, fontWeight: 700, color: 'var(--gc-slate)' }}>
                    ...
                    >
                      <span
                        style={{
                          ...
                          display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 14, fontWeight: 700, marginTop: 1, transition: 'all .18s',
                        }}
                      >
                        {LETTERS[i]}
                      </span>
                      <span style={{ fontSize: 17.5, color: 'var(--gc-slate)', lineHeight: 1.45 }}>{o.text}</span>
                    </div>
                  );
                })}
              </div>
        ...
        return (
          <div style={{ maxWidth: 680, margin: '0 auto', padding: '28px 24px 70px' }}>
              ...
              return (
                <div key={s} style={{ marginBottom: 14 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                    <span style={{ fontWeight: 600, fontSize: 17.5, color: 'var(--gc-slate)' }}>{SKILL_LABELS[s] || s}</span>
                    <span style={{ fontSize: 15, color: 'var(--gc-emerald)', fontWeight: 600 }}>{pct}%</span>
                  </div>
            ...
            <div style={{ background: '#fff', border: '1px solid var(--gc-border)', borderRadius: 14, padding: 28, textAlign: 'center', marginTop: 16 }}>
              ...
              <p style={{ fontSize: 17, fontWeight: 300, color: 'var(--gc-ink-muted)', lineHeight: 1.6, marginBottom: 18 }}>
