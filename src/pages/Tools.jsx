...
export default function Tools() {
  return (
    <div className="page-shell">
      ...
      <div style={{ background: 'var(--gc-navy-deep)', padding: '64px 44px 56px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: -90, left: -70, width: 320, height: 320, borderRadius: '50%', background: 'radial-gradient(circle, rgba(186,217,243,.22), transparent 70%)' }} />
        <div style={{ position: 'relative', zIndex: 2 }}>
          ...
          <div style={{ fontFamily: 'var(--font-serif)', fontSize: 46, fontWeight: 700, color: '#fff', lineHeight: 1.1, maxWidth: 640, margin: '0 auto' }}>
            Start with a <span style={{ fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: 400, color: 'var(--gc-lavender-soft)' }}>question.</span>
          </div>
          <p style={{ fontSize: 16, fontWeight: 300, color: 'rgba(255,255,255,.7)', lineHeight: 1.8, maxWidth: 520, margin: '20px auto 0' }}>
