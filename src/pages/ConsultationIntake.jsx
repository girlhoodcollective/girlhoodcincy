        ...
        return (
          <div
            ...
            style={{
              ...
              fontSize: 17, color: sel ? '#fff' : 'var(--gc-slate)', background: sel ? 'var(--gc-navy)' : '#fff', transition: 'all .2s', userSelect: 'none',
            }}
          >
            {d.label}
          </div>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '0 24px 80px' }}>
        {section === 1 && (
          <Card>
            ...
            <div style={{ fontFamily: 'var(--font-serif)', fontSize: 35, fontWeight: 700, color: 'var(--gc-slate)', marginBottom: 8 }}>Tell me who you are.</div>
        ...
        {section === 2 && (
          <Card>
            ...
            <div style={{ fontFamily: 'var(--font-serif)', fontSize: 35, fontWeight: 700, color: 'var(--gc-slate)', marginBottom: 8 }}>What's actually going on?</div>
            <p style={{ fontSize: 18, fontWeight: 300, color: 'var(--gc-ink-muted)', lineHeight: 1.65, marginBottom: 30 }}>
        ...
        {section === 3 && (
          <Card>
            ...
            <div style={{ fontFamily: 'var(--font-serif)', fontSize: 35, fontWeight: 700, color: 'var(--gc-slate)', marginBottom: 8 }}>Tell me about the humans involved.</div>
            <p style={{ fontSize: 18, fontWeight: 300, color: 'var(--gc-ink-muted)', lineHeight: 1.65, marginBottom: 30 }}>
            ...
            <div style={{ marginBottom: 24 }}>
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        fontSize: 19, fontWeight: 600, color: sel ? '#fff' : 'var(--gc-slate)', background: sel ? 'var(--gc-emerald)' : '#fff',
              ...
              {psychSafety && (
                <div style={{ background: 'var(--gc-sage-light)', borderLeft: '3px solid var(--gc-emerald)', padding: '14px 18px', borderRadius: '0 8px 8px 0', marginTop: 14, fontSize: 16, color: 'var(--gc-ink)', lineHeight: 1.6 }}>
        ...
        {section === 4 && (
          <Card>
            ...
            <div style={{ fontFamily: 'var(--font-serif)', fontSize: 35, fontWeight: 700, color: 'var(--gc-slate)', marginBottom: 8 }}>What does success actually look like?</div>
            <p style={{ fontSize: 18, fontWeight: 300, color: 'var(--gc-ink-muted)', lineHeight: 1.65, marginBottom: 30 }}>
        ...
        {section === 5 && (
          <Card>
            ...
            <div style={{ fontFamily: 'var(--font-serif)', fontSize: 35, fontWeight: 700, color: 'var(--gc-slate)', marginBottom: 8 }}>A few harder questions.</div>
            <p style={{ fontSize: 18, fontWeight: 300, color: 'var(--gc-ink-muted)', lineHeight: 1.65, marginBottom: 30 }}>
          ...
          <div style={{ marginTop: 36 }}>
            <div style={{ background: 'var(--gc-navy)', borderRadius: 14, padding: 44, textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
              ...
              <div style={{ position: 'relative', zIndex: 2 }}>
                ...
                <div style={{ fontFamily: 'var(--font-serif)', fontSize: 37.5, fontWeight: 700, color: '#fff' }}>{firstName}, you're in the right place.</div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14, marginTop: 16 }}>
              {buildResultCards().map((c) => (
                <div key={c.label} style={{ background: '#fff', border: '1px solid var(--gc-border)', borderRadius: 12, borderTop: '3px solid var(--gc-emerald)', padding: '28px 30px' }}>
                  ...
                  <div style={{ fontFamily: 'var(--font-serif)', fontSize: 22.5, fontWeight: 700, color: 'var(--gc-slate)', marginBottom: 8 }}>{c.title}</div>
            ...
            <div style={{ background: 'var(--gc-slate)', borderRadius: 12, padding: '26px 30px', marginTop: 14, textAlign: 'center' }}>
              <div style={{ fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontSize: 22.5, color: '#fff', lineHeight: 1.6 }}>{quote}</div>
            </div>

            <div style={{ textAlign: 'center', padding: '40px 20px 10px' }}>
              <div style={{ fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontSize: 25, color: 'var(--gc-emerald)', marginBottom: 8 }}>Let's get to work.</div>
              <p style={{ fontSize: 17.5, fontWeight: 300, color: 'var(--gc-ink-muted)', lineHeight: 1.7, maxWidth: 440, margin: '0 auto 22px' }}>
              ...
              {submitError && (
                <p style={{ fontSize: 16, color: '#c0392b', maxWidth: 440, margin: '0 auto 20px' }}>
