      ...
      {defs.map((d) => {
        ...
        return (
          ...
          >
            ...
            <div>
              <div style={{ fontSize: 16, fontWeight: 500, color: 'var(--gc-slate)', lineHeight: 1.35 }}>{d.label}</div>
    ...
    <div className="flow-shell" style={{ minHeight: '100vh', background: 'var(--gc-cream)' }}>
      ...
      <div style={{ background: 'var(--gc-cream)', padding: '60px 32px 64px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: 640, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 16, fontWeight: 300, color: 'var(--gc-ink-muted)', lineHeight: 1.8, maxWidth: 500, margin: '18px auto 32px' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '0 24px 80px' }}>
        {section === 1 && (
          <Card>
            ...
            <p style={{ fontSize: 16, fontWeight: 300, color: 'var(--gc-ink-muted)', lineHeight: 1.65, marginBottom: 30 }}>
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        fontSize: 16, fontWeight: 600, color: sel ? '#fff' : 'var(--gc-slate)', background: sel ? 'var(--gc-emerald)' : '#fff',
          ...
          <div style={{ marginTop: 36 }}>
            <div style={{ background: 'var(--gc-navy)', borderRadius: 14, padding: 44, textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
              ...
              <div style={{ position: 'relative', zIndex: 2 }}>
                ...
                <p style={{ fontSize: 16, fontWeight: 300, color: 'rgba(255,255,255,.62)', lineHeight: 1.7, maxWidth: 440, margin: '12px auto 0' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14, marginTop: 16 }}>
              {buildResultCards().map((c) => (
                <div key={c.label} style={{ background: '#fff', border: '1px solid var(--gc-border)', borderRadius: 12, borderTop: '3px solid var(--gc-emerald)', padding: '28px 30px' }}>
                  ...
                  <p style={{ fontSize: 16, fontWeight: 300, color: 'var(--gc-ink)', lineHeight: 1.75 }}>{c.body}</p>
                </div>
              ))}
            </div>
            ...
            <div style={{ textAlign: 'center', padding: '40px 20px 10px' }}>
              ...
              <p style={{ fontSize: 16, fontWeight: 300, color: 'var(--gc-ink-muted)', lineHeight: 1.7, maxWidth: 440, margin: '0 auto 22px' }}>
